...
CREATE TABLE COMMUNITY_LIKE(
    COMMUNITY_LIKE NUMBER PRIMARY KEY,
    COMMUNITY_BOARD_NO NUMBER REFERENCES COMMUNITY_BOARD(COMMUNITY_BOARD_NO) NOT NULL,
    EMP_NO NUMBER REFERENCES EMPLOYEE(EMP_NO) NOT NULL
);

COMMENT ON COLUMN COMMUNITY_LIKE.COMMUNITY_LIKE IS '좋아요번호';
...
CREATE TABLE COMMUNITY_REPLY(
    ...
    PARENT_REPLY_NO NUMBER REFERENCES COMMUNITY_REPLY(COMMUNITY_REPLY_NO)
);
...
CREATE TABLE NOTICE(
    ...
    NOTICE_ORIGIN_NAME VARCHAR2(255),
    NOTICE_CHANGE_NAME VARCHAR2(255),
    NOTICE_FILE_LEVEL NUMBER DEFAULT 0
);
...
COMMENT ON COLUMN NOTICE.NOTICE_ORIGIN_NAME IS '파일원본명';
COMMENT ON COLUMN NOTICE.NOTICE_CHANGE_NAME IS '파일수정명';
COMMENT ON COLUMN NOTICE.NOTICE_FILE_LEVEL IS '파일레벨';
...
CREATE TABLE NOTICE_ATTACHMENT(
    ...
    NOTICE_UPLOAD_DATE DATE,
    NOTICE_FILE_LEVEL NUMBER NOT NULL CHECK (NOTICE_FILE_LEVEL IN(0, 1)),
    NOTICE_ATTACHMENT_STATUS VARCHAR2(1) DEFAULT 'Y',
...
CREATE TABLE CLASS_DATA_ROOM(
    ...
    REF_CLTNO NUMBER DEFAULT 2, --보존연한
...
COMMENT ON COLUMN CLASS_DATA_ROOM.REF_CLTNO IS '보존연한';
