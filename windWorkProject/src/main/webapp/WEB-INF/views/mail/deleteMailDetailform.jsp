					...
					<div class="maildetailForm-table-box">
						...
						<div class="mail-btns">
							<div class="mail-btnss">
								<button class="form-button1" onclick = "restoreMailOnly(${email.emailNo})">복구</button>
								<button class="form-button2"  onclick="detailDeleteMailForm(${email.emailNo}, 2)" >삭제</button>
							</div>
						</div>
					</div>
				</div>
