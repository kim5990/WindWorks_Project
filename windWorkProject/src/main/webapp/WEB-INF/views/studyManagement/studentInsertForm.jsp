                    ...
                    <div style="height: auto; width: 100%;">
                        <table>
                            <tr>
                                ...
                                <td class="student-img-td flex-td">
                                    <div class="input-photo" onclick="onclickProfileUpload()">
                                        <img id="profile-img-tag" class="student-profile-img" src="./resources/common/images/person.png">
                                        <div class="student-profile-img-text"><div>이미지 클릭시 변경</div></div>
                                    </div>
                                    <div class="student-delete-btn-div"><input type="button" class="student-btn" onclick="profileImageDelete();" value="삭제"></div>                             
                                    <input type="file" style="display: none;" name="studentfile" onchange="profileImageChange(this, './resources/common/images/person.png');" id="profile-img-upload">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td  class="student-birth-input"><input class="student-input" name="studentAddress" id="sample4_roadAddress" type="text">
                                    <input type="button" class="student-input student-address-btn" onclick="sample4_execDaumPostcode()"
                                        value="주소 검색">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="radio" name="studentGender" id="male" value="남"><label for="male">남자</label>
                            ...
                            <tr>
                                ...
                                <td style="height: auto; width: 90%;"><textarea name = "studentMemo" class="student-textarea"></textarea></td>
                            </tr>
                            <tr>
                                ...
                                <td class="student-birth-input">
                                    <select class="student-select" name="classroomNo">
                                        <c:forEach var = "classroom" items = "${classroomList}" >
                                            <option value="${classroom.classroomNo}" >${classroom.classroomCategoryName}</option>
                                        </c:forEach>
                                    </select>
