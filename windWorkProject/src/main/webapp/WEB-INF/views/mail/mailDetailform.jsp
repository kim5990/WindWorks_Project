					...
					<div class="maildetailForm-table-box">
						<table>
							<tr>
								...
								<td class="maildetailForm-table-td"><button class="maildetailForm-btn">${email.empName}
							...
							<tr>
								...
								<td class="maildetailForm-table-td"><button class="maildetailForm-btn">
										${email.empSenderName}
										${email.empDeptName} ${email.empJobName} ${email.empEmail}</button></td>
							</tr>
							<tr>
						...
						<div class="mail-btns">
							<div class="mail-btnss">
								<button class="form-button1" onclick="replyMailForm(${email.emailNo})" >답장</button>
								<button class="form-button2" onclick="detailDeleteMailForm(${email.emailNo}, 0)">삭제</button>
							</div>
						</div>
					</div>
				</div>
