<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body onload="sendMailList(), emailOnload()">
            ...
            <div class="menu">
                        ...
                        <ul class="mail-menu-ul">
                            ...
                            <ul class="mail-menu-ul-sub">
                                <li class="mail-menu-li-sub ">
                                    ...
                                    <div id="sendputMailCount" class="trash-btn">${readListCount}</div>
                                </li>
                ...
                <div class="mail-right-bar">
                    <h4 style="padding-top: 20px; padding-left: 30px; margin-bottom: 0px;">보낸메일함</h4>
                    <div class="mail-right-menu">

                        <div class="mail-select">
                            <select name="boardLimit" onchange="changeSendMailBoardLimit(${pi.currentPage})"
                                id="sendboardLimit">
                        ...
                        <button class="mail-btn1-mode" onclick="mailsendDeleteBtn(${pi.currentPage})">
                        ...
                        <button class="mail-btn1-mode" data-bs-toggle="modal" data-bs-target="#emailSendModal">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <button class="mail-btn1-mode2" onclick="notReadMail(1, ${pi.currentPage})">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <button class="mail-btn1-mode"  onclick="readMail(1, ${pi.currentPage})">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <button class="mail-btn1-mode2" id="sendMailCount">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <div class="mail-right-search-box">
                            <div class="mail-right-search-container">
                                <select class="mail-right-search-select" id = "mail-send-search-select">
                                ...
                                <div class="mail-right-search-input1">
                                    <input class="mail-right-search-input" id = "mailSendSearchInput" onkeyup="mailSendSearch(event)" type="text">
                                </div>
                    ...
                    <div class="mail-right-middle">
                        <table class="mail-right-table">
                            ...
                            <tbody class="mail-right-tbody" id="sendEmailList">

                            </tbody>
                        </table>

                    </div>
                    <div class="mail-right-bottom" id="sendMailListPi">
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="relaySendMail()">전달</button>
                    </div>
                </div>
            </div>
        </div>
