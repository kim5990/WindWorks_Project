                    ...
                    <div class="createLectureMaterials-createInputs-container">
                        ...
                        <table class="createLectureMaterials-createInputs-table">
                            ...
                            <tr>
                                ...
                                <td style="height: 42px;">
                                    <input class="form-control form-control-sm" value="${c.classDataTitle}" name="classDataTitle" type="text"
                                ...
                                <td style="height: 30px;">
                                    <ui class="createLectureMaterials-file-upload-wrap2">
                                        <c:forEach var = "i"  begin="0" end="${fn:length(calist)}">
                                            <li class="fileItem">
                                                <a href="${calist[i].classFilePath}" download="${calist[i].classFilePath}"><span class = "closeButton">${calist[i].classOriginName}</span></a>
                                            </li>
                                                <input type="hidden" name = "filePath" value = "${calist[i].classFilePath }">
                                                <input type="hidden" name = "fileNo" value = "${calist[i].classFileNo }">
                                        </c:forEach>
                                    </ui>
                                </td>
                            </tr>
                                            ...
                                            <span>
                                                ...
                                                <span>
                                                    <label id="create-fileSelected-label" for="create-fileSelected">파일
                                                        선택</label>
                                                    <input type="file" name="reupfiles" class="create-fileSelected"
