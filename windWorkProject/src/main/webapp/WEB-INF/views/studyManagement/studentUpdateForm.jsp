        ...
        <body onload="lessonOnload()">
            ...
            <div class="menu">
                <div class="studentInsertForm">
                    <form action="update.stm" method="post" enctype="multipart/form-data" class="student-insert">
                        ...
                        <div style="height: auto; width: 100%;">
                            <table>
                                    ...
                                    <td class="student-img-td flex-td">
                                        <div class="input-photo" onclick="onclickProfileUpload()">
                                            <img id="profile-img-tag" class="student-profile-img"
                                                src="./${student.studentProfilePath}">
                                        ...
                                        <input type="file" style="display: none;" name="studentfile"
                                            onchange="profileImageChange(this, '${student.studentProfilePath}');"
                                            id="profile-img-upload">
                                    </td>
                                </tr>
                                <tr>
                                    <th class="student-th ">이름 *</th>
                                    <td><input class="student-input" readonly name="studentName"
                                            value="${student.studentName}" type="text"></td>
                                </tr>
                                <tr>
                                    <th class="student-th ">휴대폰 *</th>
                                    <td><input class="student-input" readonly name="studentPhone"
                                            value="${student.studentPhone}" type="text"></td>
                                </tr>
                                <tr>
                                    <th class="student-th ">이메일 *</th>
                                    <td><input class="student-input" readonly name="studentEmail"
                                            value="${student.studentEmail}" type="text"></td>
                                </tr>
                                <tr>
                                    <th class="student-th ">주소 </th>
                                    <td class="student-birth-input"><input class="student-input" name="studentAddress"
                                            id="sample4_roadAddress" value="${student.studentAddress}" type="text">
                                ...
                                <tr>
                                    ...
                                    <td><input class="student-input" value="${student.studentBirth}" name="studentBirth"
                                            type="date"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${student.studentGender eq '남'}">
                                                <input type="radio" checked name="studentGender" id="male"
                                                    value="남"><label for="male">남자</label>
                                                <input type="radio" name="studentGender" id="female" value="여"><label
                                                    for="female">여자</label>
                                            </c:when>
                                            <c:otherwise>
                                                <input type="radio" name="studentGender" id="male" value="남"><label
                                                    for="male">남자</label>
                                                <input type="radio" checked name="studentGender" id="female"
                                                    value="여"><label for="female">여자</label>
                                            </c:otherwise>
                                        </c:choose>
                                ...
                                <tr>
                                    ...
                                    <td style="height: auto; width: 90%;"><textarea name="studentMemo"
                                            class="student-textarea">${student.studentMemo}</textarea></td>
                                </tr>
                                <tr>
                        ...
                        <div class="student-add-submit-div">
                            <button type="submit" class="form-button1">수정하기</button>
